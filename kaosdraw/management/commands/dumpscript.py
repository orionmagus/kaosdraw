...
def get_models(app_labels):
    """ Gets a list of models for the given app labels, with some exceptions. 
        TODOs: If a required model is referenced, it should also be included.
    ...
    # TODOs: This should be "appname.modelname" string
    from django.contrib.contenttypes.models import ContentType
...
class InstanceCode(Code):
    ...
    def get_lines(self, force=False):
        ...
        if force:
            # TODOs: Check that M2M are not affected
    ...
    def skip(self):
        """ Determine whether or not this object should be skipped.
            ...
            TODOs: Allow the user to force its creation?
        """
